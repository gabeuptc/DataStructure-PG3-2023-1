...
public class ManagerPerson202114852 {
    ...
    private ManagerModel202114852 model202114852;

    BinaryTree<Person> treePerson;

    public ManagerPerson202114852(ManagerModel202114852 model202114852){
        this.model202114852 = new ManagerModel202114852();
