...
public class ManagerPerson202128710 {
    ...
    public void editPerson(Person person){
        for (Person auxPerson: listPerson) {
            if(auxPerson.getId()==person.getId()){
                auxPerson.setCode(person.getCode());
                auxPerson.setName(person.getName());
                return;
            }
        }
    }
    ...
    public Person getPerson(String attribute){
        for (Person auxPerson: listPerson) {
            if(attribute.equals(auxPerson.getCode()) || attribute.equals(auxPerson.getName())){
                return auxPerson;
            }
        }
        return null;
