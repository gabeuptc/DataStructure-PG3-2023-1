...
import co.edu.uptc.models.Model201612075.ManagerModel201612075;
...
public class ManagerGeneral {
    ...
    ContratBills.Model model201612075;
    ...
    private void createModels() {
        ...
        model201612075 = new ManagerModel201612075();
    ...
    public void configModelOtherUser() {
        // TODO aqui se configura para cado estudiante el modelo y este metodo se llama
        // desde la vista
        // modelGerman.setPresenter(presenter);
    ...
    public void configModel201612075() {
        model201612075.setPresenter(presenter);
        presenter.setModel(model201612075);
        view.updatedPeople();
    }
